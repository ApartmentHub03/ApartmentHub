...
import RentalGuideDownload from '../components/rent-in/RentalGuideDownload';
...
const RentIn = () => {
    ...
    const [phoneView, setPhoneView] = useState('whatsapp');
    ...
    const handleConfirmBooking = () => {
        // Simulate booking confirmation and return to WhatsApp
        setTimeout(() => {
            setPhoneView('whatsapp');
            setSelectedDate('');
            setSelectedTime('');
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            <RentalGuideDownload translations={t} />
