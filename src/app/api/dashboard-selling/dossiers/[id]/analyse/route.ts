...
function buildSystemPrompt(sellerLang: "nl" | "en"): string {
  ...
  (2) seller-facing follow-up questions in ${sellerLangName} (the language of the seller's portal — they answer these next time they open /verkoop or /sell-intake)
