export const translations = {
    nav: {
        en: {
            ...
            amsterdam: 'Amsterdam',
            middenNederland: 'Midden Nederland',
            middenNederlandSub: 'Utrecht, Amersfoort en omgeving',
            cityModalTitle: 'Welcome to ApartmentHub',
            cityModalSubtitle: 'Select your city to see relevant listings',
        },
        nl: {
            home: 'Home',
            rentOut: 'Verhuren',
            ...
            middenNederland: 'Midden Nederland',
            middenNederlandSub: 'Utrecht, Amersfoort en omgeving',
            cityModalTitle: 'Welkom bij ApartmentHub',
            cityModalSubtitle: 'Selecteer je stad om relevante woningen te zien',
        }
    },
    home: {
        en: {
    ...
    neighborhoodNames: {
        en: {
            discoverTitle: "Discover the neighbourhoods where we can help you!",
            discoverMore: "Discover more",
            centrum: { name: "Centrum", description: "The historic heart of Amsterdam with iconic canals and monuments" },
            jordaan: { name: "Jordaan", description: "Charming neighborhood with narrow streets, authentic brown cafés and art galleries" },
            dePijp: { name: "De Pijp", description: "Vibrant area known for the Albert Cuyp Market and bustling nightlife" },
            oost: { name: "Oost", description: "Multicultural neighborhood with parks and emerging food scene" },
            noord: { name: "Noord", description: "Creative hub with industrial charm and green spaces" },
            oudZuid: { name: "Oud Zuid", description: "Prestigious with museums and Vondelpark" },
            zuidas: { name: "Zuidas", description: "Modern business district with international flair" },
            zeeburg: { name: "Zeeburg", description: "Waterside with relaxed atmosphere by the IJ" },
            nieuwWest: { name: "Nieuw West", description: "Diverse and green with modern amenities" },
            binnenstad: { name: "Binnenstad", description: "Historic heart with canals, terraces and the Dom tower." },
            wittevrouwen: { name: "Wittevrouwen", description: "Beloved 19th century area right next to the centre." },
            lombok: { name: "Lombok", description: "Multicultural neighbourhood with the lively Kanaalstraat." },
            'oog-in-al': { name: "Oog in Al", description: "Green and quiet along the Merwede canal." },
            voordorp: { name: "Voordorp", description: "Family friendly area with parks and schools." },
            'leidsche-rijn': { name: "Leidsche Rijn", description: "Modern new build district with all amenities." },
            tuinwijk: { name: "Tuinwijk", description: "Characteristic 1920s architecture close to the centre." },
            wilhelminapark: { name: "Wilhelminapark", description: "Prestigious villa area around the city park." },
        },
        nl: {
            discoverTitle: "Ontdek de wijken waar wij je kunnen helpen!",
            discoverMore: "Ontdek meer",
            centrum: { name: "Centrum", description: "Het historische hart van Amsterdam met iconische grachten en monumenten" },
            jordaan: { name: "Jordaan", description: "Charmante wijk met smalle straatjes, authentieke bruine cafés en kunstgalerijen" },
            dePijp: { name: "De Pijp", description: "Levendige buurt bekend om de Albert Cuyp Markt en bruisend nachtleven" },
            oost: { name: "Oost", description: "Multiculturele wijk met parken en opkomende foodscene" },
            noord: { name: "Noord", description: "Creatieve hub met industriële charme en groene ruimtes" },
            oudZuid: { name: "Oud Zuid", description: "Prestigieus met musea en het Vondelpark" },
            zuidas: { name: "Zuidas", description: "Modern zakendistrict met internationale uitstraling" },
            zeeburg: { name: "Zeeburg", description: "Waterrijk met ontspannen sfeer aan het IJ" },
            nieuwWest: { name: "Nieuw West", description: "Divers en groen met moderne voorzieningen" },
            binnenstad: { name: "Binnenstad", description: "Historisch hart met grachten, terrassen en de Dom." },
            wittevrouwen: { name: "Wittevrouwen", description: "Geliefde 19e eeuwse buurt vlak bij het centrum." },
            lombok: { name: "Lombok", description: "Multiculturele wijk met levendige Kanaalstraat." },
            'oog-in-al': { name: "Oog in Al", description: "Groen en rustig aan het Merwedekanaal." },
            voordorp: { name: "Voordorp", description: "Gezinsvriendelijke buurt met parken en scholen." },
            'leidsche-rijn': { name: "Leidsche Rijn", description: "Moderne nieuwbouwwijk met alle voorzieningen." },
            tuinwijk: { name: "Tuinwijk", description: "Karakteristieke jaren 20 architectuur dichtbij het centrum." },
            wilhelminapark: { name: "Wilhelminapark", description: "Prestigieuze villabuurt rond het stadspark." },
        },
    },
    faq: {
        en: {
...
translations.buy = {
    en: {
        ...
        heroSubtitle: 'Personal purchase guidance from A to Z. 1% commission excl. VAT, no cure no pay.',
        heroCta: 'Start intake form',
        heroCta2: 'Calculate what you can afford',
        howTitle: 'How does it work?',
        whyTitle: 'Why ApartmentHub',
        whatTitle: 'What do we do for you?',
        ctaTitle: '7 questions, 2 minutes',
        ctaDesc: 'Receive a personal conversation within 24 hours.',
        contactTitle: 'Direct contact',
        contactDesc: 'Speak directly with your purchasing agent.',
        heroBadge: 'Buyer guidance from A to Z',
        heroTitlePrefix: 'Find your dream home in',
        heroSubtitleNew: 'Personal guidance from search to key handover.',
        heroSubtitleExtra: 'Access to off market listings, sharp negotiation and independent advice per property.',
        heroTerms: 'Personal guidance · 1% commission excluding VAT · no cure no pay.',
        showAllSteps: 'View all steps',
        showLessSteps: 'Show less',
        calculatorCardTitle: 'Calculate your buying power',
        calculatorCardMeta: 'Free · instant',
        calculatorCardDesc: 'Calculate your maximum mortgage and purchase price based on your income and own funds.',
        calculatorCardBullet1: 'Income and own funds',
        calculatorCardBullet2: 'Maximum mortgage',
        calculatorCardBullet3: 'Maximum purchase price',
        calculatorCardCta: 'Calculate your buying power',
        intakeCardTitle: 'Fill in the intake form',
        intakeCardMeta: '7 questions · 2 minutes',
        intakeCardDesc: 'Tell us your wishes, budget and search area. We will contact you personally within 24 hours.',
        intakeCardBullet1: 'Personal search profile',
        intakeCardBullet2: 'Access to off market listings',
        intakeCardBullet3: 'Guidance up to the key',
        intakeCardCta: 'Start the intake form',
        orientationPrefix: 'Prefer to explore first?',
        orientationLink: 'See what you can buy per neighbourhood',
        whyUsTitle: 'Why choose us?',
        servicesTitle: 'What do we do for you?',
        teaserTitle: '7 questions, 2 minutes',
        teaserSubtitle: 'Receive a personal meeting within 24 hours.',
        teaserCta: 'Start intake form',
        whatsapp: 'WhatsApp us',
        mail: 'Send email',
    },
    nl: {
        heroTitle: 'Vind je droomwoning',
        heroSubtitle: 'Persoonlijke aankoopbegeleiding van A tot Z. 1% courtage excl. BTW, no cure no pay.',
        heroCta: 'Vul intake-formulier in',
        heroCta2: 'Bereken wat je kunt kopen',
        howTitle: 'Hoe werkt het?',
        whyTitle: 'Waarom ApartmentHub',
        whatTitle: 'Wat doen wij voor jou?',
        ctaTitle: '7 vragen, 2 minuten',
        ctaDesc: 'Ontvang binnen 24u een persoonlijk gesprek.',
        contactTitle: 'Direct contact',
        contactDesc: 'Spreek direct met je aankoopmakelaar.',
        heroBadge: 'Aankoopbegeleiding van A tot Z',
        heroTitlePrefix: 'Vind je droomwoning in',
        heroSubtitleNew: 'Persoonlijke begeleiding van zoektocht tot sleuteloverdracht.',
        heroSubtitleExtra: 'Toegang tot off market aanbod, scherpe onderhandeling en onafhankelijk advies per pand.',
        heroTerms: 'Persoonlijke begeleiding · 1% courtage exclusief BTW · no cure no pay.',
        showAllSteps: 'Bekijk alle stappen',
        showLessSteps: 'Toon minder',
        calculatorCardTitle: 'Bereken je koopkracht',
        calculatorCardMeta: 'Gratis · direct',
        calculatorCardDesc: 'Bereken je maximale hypotheek en koopprijs op basis van je inkomen en eigen geld.',
        calculatorCardBullet1: 'Inkomen en eigen geld',
        calculatorCardBullet2: 'Maximale hypotheek',
        calculatorCardBullet3: 'Maximale koopprijs',
        calculatorCardCta: 'Bereken je koopkracht',
        intakeCardTitle: 'Vul het intakeformulier in',
        intakeCardMeta: '7 vragen · 2 minuten',
        intakeCardDesc: 'Vertel ons je wensen, budget en zoekgebied. Wij nemen binnen 24 uur persoonlijk contact op.',
        intakeCardBullet1: 'Persoonlijk zoekprofiel',
        intakeCardBullet2: 'Toegang tot off market aanbod',
        intakeCardBullet3: 'Begeleiding tot de sleutel',
        intakeCardCta: 'Start het intakeformulier',
        orientationPrefix: 'Liever eerst oriënteren?',
        orientationLink: 'Bekijk wat je kunt kopen per wijk',
        whyUsTitle: 'Waarom voor ons kiezen?',
        servicesTitle: 'Wat doen wij voor jou?',
        teaserTitle: '7 vragen, 2 minuten',
        teaserSubtitle: 'Ontvang binnen 24u een persoonlijk gesprek.',
        teaserCta: 'Start intake formulier',
...
translations.sell = {
    en: {
        ...
        heroSubtitle: 'Personal sales guidance. 1% commission excl. VAT, no cure no pay. Off-market exposure where possible.',
        heroCta: 'Calculate your sale value',
        valuationTitle: 'What is your property worth?',
        valuationDesc: 'Enter your address and we automatically retrieve the construction year and surface area from the Land Registry, show your property on the map and calculate a substantiated value indication. In 2 minutes, free and without obligation.',
        valuationCta: 'Start your free valuation',
        howTitle: 'How does it work?',
        howSubtitle: 'Selling is more than putting a sign in the garden. This is how we do it, from first conversation to key handover.',
        whyTitle: 'What you get from us',
        contactTitle: 'Direct contact',
        contactDesc: 'Speak directly with your sales agent.',
        heroBadge: 'Free property valuation in 2 minutes',
        heroTitlePrefix: 'What is your home worth in',
        heroTitleSuffix: '?',
        heroIntro: 'Get a well founded sale value right away.',
        heroIntroExtra: 'Enter your address and we automatically retrieve the build year and floor area from the Land Registry and show your home on the map.',
        heroCallUs: 'Call us',
        heroUsps: 'Personal guidance · 1% commission excluding VAT · no cure no pay.',
        showAllSteps: 'View all steps',
        showLessSteps: 'Show less',
        benefitsHeading: 'What you get from us',
        contactSubtitle: 'Speak directly with your selling agent in Amsterdam.',
        contactCalcButton: 'Calculate your sale value',
        whatsapp: 'WhatsApp us',
        mail: 'Send email',
        googleReviewsHeading: 'What clients say about us',
        googleReviewsCount: '{{count}} reviews · rated on Google',
        googleReviewsCta: 'Read all our reviews on Google',
    },
    nl: {
        heroTitle: 'Verkoop je woning',
        heroSubtitle: 'Persoonlijke verkoopbegeleiding. 1% courtage excl. BTW, no cure no pay. Off-market exposure waar het kan.',
        heroCta: 'Bereken je verkoopwaarde',
        valuationTitle: 'Wat is jouw woning waard?',
        valuationDesc: 'Vul je adres in en wij halen automatisch het bouwjaar en de oppervlakte op uit het Kadaster, tonen je woning op de kaart en berekenen een onderbouwde waarde-indicatie. In 2 minuten, gratis en vrijblijvend.',
        valuationCta: 'Start je gratis waardebepaling',
        howTitle: 'Hoe werkt het?',
        howSubtitle: 'Verkopen is meer dan een bordje in de tuin. Dit is hoe wij het aanpakken, van eerste gesprek tot sleuteloverdracht.',
        whyTitle: 'Wat krijg je van ons',
        contactTitle: 'Direct contact',
        contactDesc: 'Spreek direct met je verkoopmakelaar.',
        heroBadge: 'Gratis waardebepaling in 2 minuten',
        heroTitlePrefix: 'Wat levert jouw woning op in',
        heroTitleSuffix: '?',
        heroIntro: 'Ontdek direct een onderbouwde verkoopwaarde.',
        heroIntroExtra: 'Vul je adres in, wij halen bouwjaar en oppervlakte automatisch op uit het Kadaster en tonen je woning op de kaart.',
        heroCallUs: 'Bel ons',
        heroUsps: 'Persoonlijke begeleiding · 1% courtage exclusief BTW · no cure no pay.',
        showAllSteps: 'Bekijk alle stappen',
        showLessSteps: 'Toon minder',
        benefitsHeading: 'Wat krijg je van ons',
        contactSubtitle: 'Spreek direct met je verkoopmakelaar in Amsterdam.',
        contactCalcButton: 'Bereken je verkoopwaarde',
        whatsapp: 'WhatsApp ons',
        mail: 'Stuur mail',
        googleReviewsHeading: 'Wat klanten over ons zeggen',
        googleReviewsCount: '{{count}} reviews · beoordeeld op Google',
        googleReviewsCta: 'Lees al onze reviews op Google',
    }
};

translations.valuation = {
    en: {
        backLink: 'Back to sell',
        badge: 'Free and without obligation',
        title: 'What is your property worth?',
        subtitle: 'Enter your address and we automatically retrieve the construction year and surface area from the Land Registry (BAG). Get a substantiated value indication in 2 minutes.',
        step: 'Step',
        stepOf: 'of',
        step1Title: 'Where is your property?',
        addressLabel: 'Address and house number',
        postcodeLabel: 'Postcode',
        cityLabel: 'City / region',
        districtLabel: 'District',
        searchBtn: 'Search my property',
        bagNote: 'Source: Kadaster BAG. Something not right? You can adjust it in the next step.',
        bagNotFound: 'We couldn\'t find this address automatically. No problem, you can fill in the details yourself in the next step.',
        step2Title: 'Tell us more about your property',
        step2Desc: 'The more you fill in, the more accurate the estimate.',
        areaLabel: 'Living area (m²)',
        typeLabel: 'Property type',
        periodLabel: 'Construction period',
        conditionLabel: 'Property condition',
        energyLabel: 'Energy label',
        outdoorLabel: 'Outdoor space',
        basementLabel: 'Basement',
        parkingLabel: 'Own parking space',
        step3Title: 'Where should we send your valuation?',
        step3Desc: 'You\'ll receive the estimate by email and we\'ll contact you personally.',
        ...
        prevBtn: 'Previous',
        nextBtn: 'Next',
        submitBtn: 'View my valuation',
        callBtn: 'Schedule a free on-site valuation',
    },
    nl: {
        backLink: 'Terug naar verkoop',
        badge: 'Gratis en vrijblijvend',
        title: 'Wat is jouw woning waard?',
        subtitle: 'Vul je adres in en wij halen automatisch het bouwjaar en de oppervlakte op uit het Kadaster (BAG). In 2 minuten een onderbouwde waarde-indicatie.',
        step: 'Stap',
        stepOf: 'van',
        step1Title: 'Waar staat je woning?',
        addressLabel: 'Adres en huisnummer',
        postcodeLabel: 'Postcode',
        cityLabel: 'Stad / regio',
        districtLabel: 'Wijk',
        searchBtn: 'Zoek mijn woning',
        bagNote: 'Bron: Kadaster BAG. Klopt iets niet? Je kunt het in de volgende stap aanpassen.',
        bagNotFound: 'We konden dit adres niet automatisch vinden. Geen probleem, je vult de gegevens in de volgende stap zelf in.',
        step2Title: 'Vertel ons meer over je woning',
        step2Desc: 'Hoe meer je invult, hoe preciezer de indicatie.',
        areaLabel: 'Woonoppervlakte (m²)',
        typeLabel: 'Type woning',
        periodLabel: 'Bouwperiode',
        conditionLabel: 'Staat van de woning',
        energyLabel: 'Energielabel',
        outdoorLabel: 'Buitenruimte',
        basementLabel: 'Souterrain',
        parkingLabel: 'Eigen parkeerplek',
        step3Title: 'Waar mogen we je waardebepaling naartoe sturen?',
        step3Desc: 'Je ontvangt de indicatie per e-mail en wij nemen persoonlijk contact met je op.',
        ...
        prevBtn: 'Vorige',
        nextBtn: 'Volgende',
        submitBtn: 'Bekijk mijn waardebepaling',
        callBtn: 'Plan een gratis waardebepaling op locatie',
    }
};

translations.buyLead = {
    en: {
        step: 'Step',
        stepOf: 'of',
        journeyTitle: 'I want help with...',
        journeyDesc: 'Choose how we can help you.',
        step2Title: 'Let\'s get to know each other',
        step2Desc: 'We use your email for appointments and your phone for WhatsApp updates.',
        firstNameLabel: 'First name',
        lastNameLabel: 'Last name',
        emailLabel: 'Email address',
        phoneLabel: 'Phone / WhatsApp',
        nationalityLabel: 'Nationality',
        step3Title: 'About you as a buyer',
        buyerTypeLabel: 'What type of buyer are you?',
        livesInNLLabel: 'Living in the Netherlands?',
        householdLabel: 'Solo or with partner?',
        step4Title: 'Financing',
        mortgageLabel: 'Mortgage status',
        budgetLabel: 'Purchase budget k.k.',
        ownCapitalLabel: 'Own funds available (€)',
        step5Title: 'Your housing preferences',
        otherNeighborhoodLabel: 'Other neighborhood?',
        addBtn: 'Add',
        bedroomsLabel: 'Minimum bedrooms',
        propertyTypeLabel: 'Property type',
        propertyConditionLabel: 'Property condition',
        minSqmLabel: 'Min m²',
        mustHavesLabel: 'Must-haves',
        step6Title: 'Timeline',
        timelineLabel: 'When do you want to buy?',
        step7Title: 'Almost done, check your details',
        summaryName: 'Name',
        summaryPhone: 'Phone',
        summaryNationality: 'Nationality',
        summaryProfile: 'Buyer profile',
        summaryFinancing: 'Financing',
        summaryNeighborhoods: 'Neighborhoods',
        ...
        consentAnd: 'and',
        consentPrivacy: 'privacy policy',
        marketingOptIn: 'Also send me off-market listings and market updates via WhatsApp.',
        prevBtn: 'Previous',
        nextBtn: 'Next',
        submitBtn: 'Schedule intro conversation',
        fillRequired: 'Please fill in the required fields.',
        thankYou: 'Thank you',
        successMessage: 'We\'ll call you within 24 hours. Keep an eye on your WhatsApp.',
        backHome: 'Back to home',
        viewMarketData: 'View our market data',
    },
    nl: {
        step: 'Stap',
        stepOf: 'van',
        journeyTitle: 'Ik wil hulp met...',
        journeyDesc: 'Kies waarmee we je kunnen helpen.',
        step2Title: 'Even kennismaken',
        step2Desc: 'We gebruiken je email voor afspraken en je telefoon voor WhatsApp-updates.',
        firstNameLabel: 'Voornaam',
        lastNameLabel: 'Achternaam',
        emailLabel: 'Emailadres',
        phoneLabel: 'Telefoonnummer / WhatsApp',
        nationalityLabel: 'Nationaliteit',
        step3Title: 'Over jou als koper',
        buyerTypeLabel: 'Wat voor koper ben je?',
        livesInNLLabel: 'Volledig in Nederland wonen?',
        householdLabel: 'Met partner of solo?',
        step4Title: 'Financiering',
        mortgageLabel: 'Hypotheek-status',
        budgetLabel: 'Aankoopbudget k.k.',
        ownCapitalLabel: 'Eigen geld beschikbaar (€)',
        step5Title: 'Jouw woonwensen',
        otherNeighborhoodLabel: 'Andere wijk?',
        addBtn: 'Toevoegen',
        bedroomsLabel: 'Min slaapkamers',
        propertyTypeLabel: 'Type woning',
        propertyConditionLabel: 'Staat van de woning',
        minSqmLabel: 'Min m²',
        mustHavesLabel: 'Must-haves',
        step6Title: 'Timing',
        timelineLabel: 'Wanneer wil je kopen?',
        step7Title: 'Bijna klaar, controleer je gegevens',
        summaryName: 'Naam',
        summaryPhone: 'Telefoon',
        summaryNationality: 'Nationaliteit',
        summaryProfile: 'Koperprofiel',
        summaryFinancing: 'Financiering',
        summaryNeighborhoods: 'Wijken',
        summaryProperty: 'Woning',
        summaryTimeline: 'Timing',
        consentPrefix: 'Ik ga akkoord met de',
        consentTerms: 'algemene voorwaarden koop',
        consentAnd: 'en de',
        consentPrivacy: 'privacyverklaring',
        marketingOptIn: 'Stuur me ook off-market aanbod en marktupdates via WhatsApp.',
        prevBtn: 'Vorige',
        nextBtn: 'Volgende',
        submitBtn: 'Plan kennismakingsgesprek',
        fillRequired: 'Vul de verplichte velden in.',
        thankYou: 'Bedankt',
        successMessage: 'We bellen je binnen 24 uur. Houd je WhatsApp in de gaten.',
        backHome: 'Terug naar home',
        viewMarketData: 'Bekijk vast onze marktdata',
    }
};

translations.buyingPower = {
    en: {
        backLink: 'Back to buy',
        badge: 'Mortgage calculator',
        heading: 'What can you afford?',
        intro: 'Calculate your maximum purchase price and monthly costs in 30 seconds.',
        disclaimerTop: 'Indicative calculation based on Nibud standards and current interest rates. No guarantee.',
        fields: {
            inkomen: 'Annual income (gross)',
            partner: 'Partner income (gross, optional)',
            eigenGeld: 'Own contribution / savings',
            rente: 'Mortgage interest rate (%)',
            studieschuld: 'Student debt',
            energielabel: 'Energy label of target home',
            energielabelPlaceholder: 'Select energy label',
            city: 'City / region',
        },
        empty: 'Enter your income to see your buying power.',
        result: {
            maxKoopprijs: 'Maximum purchase price',
            maxHypotheek: 'Maximum mortgage',
            maandlasten: 'Monthly costs',
            maandlastenSuffix: '/mo',
            gemiddeldIn: 'Avg. m² in {regio}',
            m2: '{m2} m²',
        },
        onderbouwing: {
            title: 'How is this calculated?',
            toetsinkomen: 'Assessable income: {bedrag}',
            financieringslast: 'Housing cost ratio: {percentage}%',
            toetsrente: 'Test interest rate: {rente}%',
            energieExtra: 'Energy label bonus: +{bedrag}',
            studieEffect: 'Student debt impact: -{bedrag}',
        },
        disclaimerBottom: 'This is an indicative calculation. Always consult a mortgage advisor for a precise quote.',
        ctaIntake: 'Fill in the intake form',
        ctaBel: 'Call our buying agent',
    },
    nl: {
        backLink: 'Terug naar koop',
        badge: 'Hypotheekberekening',
        heading: 'Wat kun je kopen?',
        intro: 'Bereken je maximale koopprijs en maandlasten in 30 seconden.',
        disclaimerTop: 'Indicatieve berekening op basis van Nibud-normen en actuele rente. Geen garantie.',
        fields: {
            inkomen: 'Bruto jaarinkomen',
            partner: 'Bruto jaarinkomen partner (optioneel)',
            eigenGeld: 'Eigen geld / spaargeld',
            rente: 'Hypotheekrente (%)',
            studieschuld: 'Studieschuld',
            energielabel: 'Energielabel van de gewenste woning',
            energielabelPlaceholder: 'Selecteer energielabel',
            city: 'Stad / regio',
        },
        empty: 'Vul je inkomen in om je koopkracht te bekijken.',
        result: {
            maxKoopprijs: 'Maximale koopprijs',
            maxHypotheek: 'Maximale hypotheek',
            maandlasten: 'Maandlasten',
            maandlastenSuffix: '/mnd',
            gemiddeldIn: 'Gem. m² in {regio}',
            m2: '{m2} m²',
        },
        onderbouwing: {
            title: 'Hoe wordt dit berekend?',
            toetsinkomen: 'Toetsinkomen: {bedrag}',
            financieringslast: 'Woonquote: {percentage}%',
            toetsrente: 'Toetsrente: {rente}%',
            energieExtra: 'Energielabel bonus: +{bedrag}',
            studieEffect: 'Invloed studieschuld: -{bedrag}',
        },
        disclaimerBottom: 'Dit is een indicatieve berekening. Raadpleeg altijd een hypotheekadviseur voor een exacte berekening.',
        ctaIntake: 'Vul het intakeformulier in',
        ctaBel: 'Bel direct met onze aankoopmakelaar',
    }
};

translations.termsBuy = {
    en: {
        title: 'Terms and Conditions — Purchase Brokerage',
        subtitle: 'Apartmenthub B.V. · mediation for the purchase of residential properties',
    },
    nl: {
...
translations.termsSell = {
    en: {
        title: 'Terms and Conditions — Sale Brokerage',
        subtitle: 'Apartmenthub B.V. · mediation for the sale of residential properties',
    },
    nl: {
