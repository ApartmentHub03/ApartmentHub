...
translations.buyingPower = {
    en: {
        ...
        step1Title: 'Your search preferences',
        step1Desc: 'Tell us what you are looking for and we will calculate what is feasible.',
        budgetLabel: 'Purchase budget (k.k.)',
        cityLabel: 'City / region',
        wijkenLabel: 'Desired neighborhood(s)',
        minM2Label: 'Minimum living area (m²)',
        bedroomsLabel: 'Minimum bedrooms',
        nextBtn: 'Next step',
        step2Title: 'Where should we send your results?',
        firstNameLabel: 'First name',
        lastNameLabel: 'Last name',
        emailLabel: 'Email address',
        phoneLabel: 'Phone number',
        ...
        resultTitle: 'Your buying power at a glance',
        suggestionsTitle: 'None of your selected neighborhoods fully fit. Consider these alternatives:',
        disclaimer: 'Indicative calculation based on average neighborhood prices, no guarantee.',
        callBtn: 'Call our buying agent directly',
        leadBtn: 'Fill in the full intake form',
    },
    nl: {
        backLink: 'Terug naar koop',
        title: 'Wat kan ik kopen?',
        step1Title: 'Jouw zoekwensen',
        step1Desc: 'Vertel ons wat je zoekt, dan rekenen wij uit wat haalbaar is.',
        budgetLabel: 'Aankoopbudget k.k.',
        cityLabel: 'Stad / regio',
        wijkenLabel: 'Gewenste wijk(en)',
        minM2Label: 'Minimum woonoppervlakte (m²)',
        bedroomsLabel: 'Minimum aantal slaapkamers',
        nextBtn: 'Volgende stap',
        step2Title: 'Waar mogen we je resultaat naartoe sturen?',
        firstNameLabel: 'Voornaam',
        lastNameLabel: 'Achternaam',
        emailLabel: 'Emailadres',
        phoneLabel: 'Telefoonnummer',
        ...
        consentPrivacy: 'privacyverklaring',
        prevBtn: 'Vorige',
        submitBtn: 'Bekijk mijn resultaat',
        resultTitle: 'Jouw koopkracht in beeld',
        suggestionsTitle: 'Geen van je geselecteerde wijken past helemaal. Kijk ook eens naar:',
        disclaimer: 'Indicatieve berekening op basis van gemiddelde wijkprijzen, geen garantie.',
        callBtn: 'Bel direct met onze aankoopmakelaar',
        leadBtn: 'Vul het volledige intakeformulier in',
    }
};
